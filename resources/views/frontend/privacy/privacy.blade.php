...
@section('content')
    <div class="site-wrapper-reveal">
        ...
        <div id="main-wrapper">
            <div class="site-wrapper-reveal">
                <div class="col-md-10" style="margin: auto;padding:0 20px">
                            ...
                            <p>
                                <b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Horizon Rising Star, Alamin Millennium Tower, 11th Floor (11-B), 75-76 Kakrail, Dhaka-1000.
                            </p>
                            ...
                            <p>
                                <b>Personal</b> Data is any information that relates to an identified or identifiable individual.
                            </p>
                            ...
                            <p>
                                <b>Flash Cookies</b> features of our Service may use local stored objects (or Flash Cookies)
                            ...
                            <p>
                                <b>Web Beacons</b> sections of our Service and our emails may contain small electronic files known as
                            ...
                            <p>
                                <span style="padding-right:20px">.</span>Comply with a legal obligation
                            </p>
                            <p>
                                <span style="padding-right:20px">.</span>Protect and defend the rights or property of the Company
                            </p>
                            <p>
                                <span style="padding-right:20px">.</span>Prevent or investigate possible wrongdoing in connection with the Service
                            </p>
                            <p>
                                <span style="padding-right:20px">.</span>Protect the personal safety of Users of the Service or the public
                            </p>
                            <p>
                                <span style="padding-right:20px">.</span>Protect against legal liability
                            </p>
                            <h5>
                            ...
                            <p style="padding-bottom:30px">
                                <span style="padding-right:20px">.</span>By email: info@horizonsolutions.tech
                            </p>
