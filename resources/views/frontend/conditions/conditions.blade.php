...
@section('content')
    <div class="site-wrapper-reveal">
        ...
        <div id="main-wrapper">
            <div class="site-wrapper-reveal">
                <div class="col-md-10 m-auto" style="padding:20px">
                            ...
                            <p>
                                <b>Country</b> refers to: Bangladesh
                            </p>
                            <p>
                                <b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Horizon Rising Star ( A concern of Sustainable IT Solutions), Alamin Millennium Tower, 11th Floor (11-B), 75-76 Kakrail, Dhaka-1000.
                            </p>
                            <p>
                            ...
                            <p>
                                <b>Terms and Conditions</b> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Terms and Conditions Generator.
                            </p>
                            <p>
                            ...
                            <p>
                                <b>Website</b> refers to Horizon Rising Star, accessible from www.horizonsolutions.tech
                            </p>
                            <p>
                            ...
                            <p style="padding-bottom:30px">
                                路         By email: info@horizonsolutions.tech
                            </p>
